...
<article class="content">
  ...
  <section class="list-section list-section--thebook">
    <?= $page->the_book()->kirbytext() ?>
  </section>

  <section class="list-section list-section--featured">
    <?= $page->featured_writing()->kirbytext() ?>
  </section>
  ...
  <section class="writing-archives">
    ...
    <?= $page->business_writing()->kirbytext() ?>

    </div>
    <div class="aside-list">

    <?= $page->personal_writing()->kirbytext() ?>
  ...
  <section class="writing-elsewhere">
    ...
    <div class="wrapper">
      <?= $page->published_elsewhere()->kirbytext() ?>
    </div>
  </section>
